...
class ChessDataset(Dataset):
    def __init__(self, trace_file, apply_mirror=False, game="chess"):
        ...
        encode_func = {
            "chess": libsmartchess.chess_encode_steps,
            "hexapawn": libsmartchess.hexapawn_encode_steps
        }
        self.steps = encode_func[game](steps, apply_mirror)
